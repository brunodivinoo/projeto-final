...
export const NIVEIS_CONFIG = [
  ...
  { nivel: 5, nome: 'Avançado', xpMin: 1000, xpMax: 1500, cor: '#f59e0b', icone: 'military_tech' },
  ...
  { nivel: 8, nome: 'Grão-Mestre', xpMin: 2800, xpMax: 3600, cor: '#14b8a6', icone: 'emoji_events' },
...
export const XP_ACOES = {
  ...
  primeiro_resumo: 30,
  nivel_up: 0, // Não dá XP, mas registra
}
...
// Função para calcular progresso no nível atual (0-100)
  ...
  const fetchXP = useCallback(async () => {
    ...
    try {
      ...
      if (xpError && xpError.code !== 'PGRST116') {
        // PGRST116 = não encontrado, vamos criar
        throw xpError
      }
