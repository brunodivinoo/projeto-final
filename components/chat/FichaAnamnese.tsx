          ...
          >
            ...
            <div className="px-4 py-3 bg-white/5 border-b border-white/10">
              <div className="flex items-center justify-between text-sm">
                <span className="text-white/60">Itens investigados</span>
            ...
            <div className="flex-1 overflow-y-auto">
              {SECOES.map(secao => {
                ...
                return (
                  <div key={secao.id} className="border-b border-white/5">
                    <button
                    ...
                    >
                      ...
                      <div className={cn(
                        ...
                        preenchido ? "bg-emerald-500/20" : "bg-white/5"
                      )}>
                        {preenchido ? (
                      ...
                      <span className={cn(
                        ...
                        preenchido ? "text-white" : "text-white/50"
                      )}>
                        {secao.label}
                      </span>
...
function renderConteudo(secaoId: string, dados: DadosFicha) {
  const Vazio = () => <span className="text-white/30 italic">Não investigado ainda</span>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 mb-4">
        <p className="text-white/60 text-sm">Itens investigados:</p>
      ...
      {faltou.length > 0 && (
        <div className="space-y-2">
          <p className="text-white/60 text-sm">Poderia ter investigado:</p>
          <div className="flex flex-wrap gap-2">
            {faltou.map((item, i) => (
