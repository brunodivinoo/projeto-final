...
const planos = [
  {
    ...
    descricao: 'Teste o chat por 30 minutos',
    economia: null,
    recursos: [
      { texto: '30 minutos de chat IA grátis', disponivel: true, destaque: true },
      ...
      { texto: 'Flashcards IA', disponivel: false, destaque: false },
  ...
  },
  {
    ...
    desconto: '-33%',
    descricao: 'Tudo ilimitado para sua aprovação',
    economia: 'R$1.200/ano',
    recursos: [
      { texto: 'Chat IA ilimitado (Claude)', disponivel: true, destaque: true },
      { texto: 'Questões ilimitadas', disponivel: true, destaque: true },
      { texto: 'Simulados ilimitados', disponivel: true, destaque: true },
      { texto: 'Flashcards ilimitados', disponivel: true, destaque: true },
      { texto: 'Resumos IA ilimitados', disponivel: true, destaque: true },
      { texto: 'Teoria nível expert', disponivel: true, destaque: false },
      { texto: 'Análise de exames e PDFs', disponivel: true, destaque: false },
