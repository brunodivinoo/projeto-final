  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-6 lg:p-8 max-w-[1200px] mx-auto pb-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-700 bg-[#1c242d] text-white text-sm font-medium hover:bg-[#232d3b] transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {/* Horas Planejadas */}
          <div className="rounded-xl border border-slate-700 bg-[#1c242d] p-5 shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-medium text-slate-400">Horas Planejadas</p>
                <h3 className="text-2xl font-bold text-white mt-1">40h</h3>
              </div>
          ...
          <div className="rounded-xl border border-slate-700 bg-[#1c242d] p-5 shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-medium text-slate-400">Horas Estudadas</p>
                <h3 className="text-2xl font-bold text-white mt-1">28h 15m</h3>
              </div>
          ...
          <div className="rounded-xl border border-slate-700 bg-[#1c242d] p-5 shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mt-1">70%</h3>
              </div>
              <div className="p-2 rounded bg-green-500/10 text-green-500">
                <span className="material-symbols-outlined">check_circle</span>
              </div>
            </div>
            <div className="w-full bg-slate-800 rounded-full h-1.5 mt-5">
        ...
        <section className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold text-white">Próxima Sessão Sugerida</h3>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold text-white">Matérias do Ciclo</h3>
            <button className="text-sm font-medium text-primary hover:text-blue-400">Ver todas</button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {/* Português */}
            <div className="group relative rounded-xl border border-slate-700 bg-[#1c242d] p-4 transition-all hover:border-primary/50 hover:shadow-md">
              ...
              <h4 className="text-base font-bold text-white mb-1">Português</h4>
              <p className="text-xs text-slate-400 mb-4">Gramática e Interpretação</p>
            ...
            <div className="group relative rounded-xl border border-slate-700 bg-[#1c242d] p-4 transition-all hover:border-primary/50 hover:shadow-md">
              ...
              <h4 className="text-base font-bold text-white mb-1">Química</h4>
              <p className="text-xs text-slate-400 mb-4">Química Orgânica</p>
              <div className="space-y-2">
                <div className="flex justify-between text-xs font-medium">
                  <span className="text-slate-400">Progresso</span>
            ...
            <div className="group relative rounded-xl border border-slate-700 bg-[#1c242d] p-4 transition-all hover:border-primary/50 hover:shadow-md">
              ...
              <h4 className="text-base font-bold text-white mb-1">Geografia</h4>
              <p className="text-xs text-slate-400 mb-4">Geopolítica Atual</p>
              <div className="space-y-2">
                <div className="flex justify-between text-xs font-medium">
                  <span className="text-slate-400">Progresso</span>
            ...
            {/* Adicionar Matéria */}
            <button className="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-700 bg-transparent p-4 min-h-[180px] hover:bg-slate-800/30 transition-colors group">
              <div className="p-3 rounded-full bg-slate-800 text-slate-400 group-hover:text-primary mb-3 transition-colors">
                <span className="material-symbols-outlined">add</span>
              </div>
              <span className="text-sm font-medium text-slate-400">Adicionar Matéria</span>
            </button>
          </div>
        </section>
      </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="bg-[#1c242d] border border-slate-700 rounded-lg shadow-xl p-1 flex items-center pr-4 cursor-pointer hover:border-primary transition-colors">
          ...
          <div className="flex flex-col mr-6">
            ...
            <span className="text-sm font-mono font-bold text-white">00:25:30</span>
          </div>
