    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-[#f6f7f8]">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-slate-200 bg-white/90 backdrop-blur-md px-10 py-3">
        <div className="flex items-center gap-4 text-slate-900">
          ...
          <h2 className="text-slate-900 text-lg font-bold leading-tight tracking-[-0.015em]">StudyConnect</h2>
        </div>
          ...
          <div className="flex flex-col max-w-[1080px] flex-1 px-5 md:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-6 rounded-xl border-2 border-primary bg-white p-8 relative shadow-xl transform md:-translate-y-2">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-slate-900 text-lg font-bold leading-tight">Pro</h3>
                  <div className="flex items-baseline gap-1 text-slate-900">
                    <span className="text-4xl font-black leading-tight tracking-[-0.033em]">R$19</span>
                    <span className="text-base font-bold leading-tight text-slate-500">/mês</span>
                  </div>
                  <p className="text-slate-500 text-sm">O melhor custo-benefício.</p>
                </div>
              ...
              <div className="flex flex-col gap-6 rounded-xl border border-slate-200 bg-white p-8 hover:border-primary/50 transition-colors">
                <div className="flex flex-col gap-2">
                  <h3 className="text-slate-900 text-lg font-bold leading-tight">Grupo</h3>
                  <div className="flex items-baseline gap-1 text-slate-900">
                    <span className="text-4xl font-black leading-tight tracking-[-0.033em]">R$49</span>
                    <span className="text-base font-bold leading-tight text-slate-500">/mês</span>
                  </div>
                  <p className="text-slate-500 text-sm">Para estudar em equipe.</p>
                </div>
                <button className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-4 bg-slate-100 text-slate-900 hover:bg-slate-200 transition-colors text-sm font-bold leading-normal tracking-[0.015em]">
                  <span className="truncate">Criar Grupo</span>
                </button>
                <div className="flex flex-col gap-3">
                  <div className="text-sm font-normal leading-normal flex gap-3 text-slate-700 items-center">
                    <span className="material-symbols-outlined text-primary text-[20px]">check</span>
